  ...
  groups: [
    {
      ...
      controls: [
        ...
        {
          type: 'select',
          key: 'header.layoutAlignment',
          label: 'Layout Alignment',
          description: 'Position of logo and buttons',
          options: [
            { value: 'between', label: 'Edges (Space Between)' },
    ...
    },
    {
      ...
      controls: [
        ...
        {
          type: 'switch',
          key: 'header.buttonUseTransparentBackground',
          label: 'Transparent Background',
          description: 'Forces background to be transparent regardless of variant',
        },
        {
          type: 'slider',
          key: 'header.buttonPaddingX',
          label: 'Horizontal Padding',
          min: 0,
          max: 48,
          step: 1,
        ...
        {
          type: 'switch',
          key: 'header.buttonShowIcon',
          label: 'Show Icons',
        },
        {
          type: 'switch',
          key: 'header.buttonShowLabel',
          label: 'Show Labels',
        },
        {
          type: 'slider',
          key: 'header.buttonLabelSizePx',
          label: 'Label Font Size',
          min: 8,
          max: 24,
          step: 1,
          suffix: 'px',
          showWhen: { key: 'header.buttonShowLabel', value: true },
        },
      ],
    },
  ],
